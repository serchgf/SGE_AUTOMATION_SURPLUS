...
def MTC_SURSGE_012_steps(sge_funct, archivo_cm_asignacion_localizacion_permanente_producto):
    ...
    print("6 Teclear input 1 1) Localizaciones y Limites")
    sge_funct.send_text('1')
    print("11 Oprimir click derecho del mouse para Pegar los datos de carga masiva cm_zonas.txt")
    sge_funct.leer_archivo_productos(archivo_cm_asignacion_localizacion_permanente_producto)
