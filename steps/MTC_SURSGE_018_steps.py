...
def MTC_SURSGE_018_steps(sge_funct, archivo_cm_Relleno_localizacion_multiple_a_multiple_masiva):
    ...
    sge_funct.leer_archivo_productos(archivo_cm_Relleno_localizacion_multiple_a_multiple_masiva)
