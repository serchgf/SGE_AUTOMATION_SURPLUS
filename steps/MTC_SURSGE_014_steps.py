...
def MTC_SURSGE_014_steps(sge_funct, archivo_cm_asignacion_zona_permanente_producto):
    ...
    print("6 Teclear input 2  2) Zonas del articulo")
    sge_funct.send_text('2')
    print("11 Oprimir click derecho del mouse para Pegar los datos de carga masiva cm_zonas.txt")
    sge_funct.leer_archivo_productos(archivo_cm_asignacion_zona_permanente_producto)
