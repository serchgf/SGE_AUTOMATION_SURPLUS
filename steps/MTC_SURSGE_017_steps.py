...
def MTC_SURSGE_017_steps(sge_funct, data):
    ...
    print("14 Leer archivo multiple_a_multiple.json para capturar la clave del almacen")
    sge_funct.send_text(data["almacen"])
    print("15 Teclear input")
    sge_funct.press_enter()
    print("16 Leer archivo multiple_a_multiple.json para capturar la linea del producto")
    sge_funct.send_text(data["linea"])
    print("17 Teclear input")
    sge_funct.press_enter()
    print("18 Leer archivo multiple_a_multiple.json para capturar el codigo del producto")
    sge_funct.send_text(data["codigo"])
    print("19 Teclear input")
    sge_funct.press_enter()
    print("20 Capturar m para modificar")
    sge_funct.send_text('m')
    print("21 Posicionarse en la localizacion multiple")
    sge_funct.flecha_abajo()
    #Se elimina el paso 22
    print("23 Presionar la combinacion de teclas: Ctrl + d para ver los detalles")
    sge_funct.press_hotkeys('ctrl+d')
    print("24 Leer archivo multiple_a_multiple.json para capturar la localizacion destino")
    sge_funct.send_text(data["localizacion_destino"])
    print("25 Teclear input")
    sge_funct.press_enter()
    print("26 Leer archivo multiple_a_multiple.json para capturar la cantidad a mover")
    sge_funct.send_text(data["cantidad_a_mover"])
    print("27 Teclear input")
    sge_funct.press_enter()
    print("28 Capturar s para continuar")
