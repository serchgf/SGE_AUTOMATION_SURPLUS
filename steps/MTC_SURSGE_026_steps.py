def MTC_SURSGE_026_steps(sge_funct, data, img_inicioFactura):
    ...
    sge_funct.press_enter()
    print("39 Presionar la combinacion de teclas: Ctrl + N")
    sge_funct.send_text('ctrl+n')
    print("40 Oprimir click derecho del mouse para Pegar la nueva localizacion multiple ")
    sge_funct.send_text(data["localizacion_multiple_destino"]) # lo obtuve del archivo de excel pestaña end to end testing
    ...
    sge_funct.press_hotkeys('ctrl+w')
    print("45 Capturar s para continuar")
