...
from steps import MTC_SURSGE_015_steps
...
#@ddt
class MTC_SURSGE_015_Tests:

    @pytest.mark.parametrize("data", cargar_datos_prueba(files.mtc_sursge_015_json))
    #@pytest.mark.flaky(reruns=1)
    def test_MTC_SURSGE_SUR_015(self, data):
        ...
        MTC_SURSGE_015_steps.MTC_SURSGE_015_steps(sge_funct, data)
