...
from steps import MTC_SURSGE_011_steps
...
#@ddt
class MTC_SURSGE_011_Tests:

    @pytest.mark.parametrize("data", cargar_datos_prueba(files.mtc_sursge_011_json))
    #@pytest.mark.flaky(reruns=1)
    def test_MTC_SURSGE_SUR_011(self, data):
        ...
        MTC_SURSGE_011_steps.MTC_SURSGE_011_steps(sge_funct, data)
        assert sge_funct.validate_image_x(images.img_asignacion_localizacion_permanente), "Error en la asignacion de localizacion al producto"
