...
from steps import MTC_SURSGE_007_steps
...
#@ddt
class MTC_SURSGE_007_Tests:

    @pytest.mark.parametrize("data", cargar_datos_prueba(files.mtc_sursge_007_json))
    #@pytest.mark.flaky(reruns=1)
    def test_MTC_SURSGE_SUR_007(self, data):
        ...
        MTC_SURSGE_007_steps.MTC_SURSGE_007_steps(sge_funct, data)
        assert sge_funct.validate_image_x(images.img_registro_alta_localizacion), "Error en la creacion de localizacion"
