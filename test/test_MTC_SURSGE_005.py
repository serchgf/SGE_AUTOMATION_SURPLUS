...
from steps import MTC_SURSGE_005_steps
...
#@ddt
class MTC_SURSGE_005_Tests:

    @pytest.mark.parametrize("data", cargar_datos_prueba(files.mtc_sursge_005_json))
    #@pytest.mark.flaky(reruns=1)
    def test_MTC_SURSGE_SUR_005(self, data):
        ...
        MTC_SURSGE_005_steps.MTC_SURSGE_005_steps(sge_funct, data)
        assert sge_funct.validate_image_x(images.img_registro_alta_correctamente), "Error en la creacion de Workzone"
