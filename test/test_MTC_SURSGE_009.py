...
from steps import MTC_SURSGE_009_steps
...
#@ddt
class MTC_SURSGE_009_Tests:

    @pytest.mark.parametrize("data", cargar_datos_prueba(files.mtc_sursge_009_json))
    #@pytest.mark.flaky(reruns=1)
    def test_MTC_SURSGE_SUR_009(self, data):
        ...
        MTC_SURSGE_009_steps.MTC_SURSGE_009_steps(sge_funct, data)
