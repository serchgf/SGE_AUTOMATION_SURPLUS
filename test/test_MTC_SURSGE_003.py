...
from steps import MTC_SURSGE_003_steps
import json
...
# @ddt
class MTC_SURSGE_003_Tests:

    @pytest.mark.parametrize("data", cargar_datos_prueba(files.mtc_sursge_003_json))
    # @pytest.mark.flaky(reruns=1)
    def test_MTC_SURSGE_SUR_003(self, data):
        ...
        MTC_SURSGE_003_steps.MTC_SURSGE_003_steps(sge_funct, data)
        assert sge_funct.validate_image_x(images.img_registro_actualizado), "Error en la creacion de Zona"
