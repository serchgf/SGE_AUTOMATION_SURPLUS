...
from steps import MTC_SURSGE_019_steps
...
#@ddt
class MTC_SURSGE_019_Tests:

    @pytest.mark.parametrize("data", cargar_datos_prueba(files.mtc_sursge_019_json))
    #@pytest.mark.flaky(reruns=1)
    def test_MTC_SURSGE_SUR_019(self, data):
        ...
        MTC_SURSGE_019_steps.MTC_SURSGE_019_steps(sge_funct, data)
